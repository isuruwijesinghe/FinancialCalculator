//
//  LoanInterestValViewController.swift
//  FinancialCalculator
//
...
class LoanInterestValViewController: ParentViewController {
    ...
    func updateFields(){
        ...
        if (tf_LoanAmount.text != "0" && tf_Payment.text != "0"  && tf_NoOfMonths.text != "0") {
...
//            interest = interest / 100
            ...
            let value : Double = Calculations.calLoanInterestValue(P: presentValue, PMT: payment, n: noOfPayments)
