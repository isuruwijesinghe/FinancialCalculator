//
//  LoanNoOfMonthsViewController.swift
//  FinancialCalculator
//
...
class LoanNoOfMonthsViewController: ParentViewController {
...
//            let noOfPayments = (tf_NoOfMonths.text! as NSString).doubleValue
            ...
            let value : Double = Calculations.calLoanNumberOfPaymentsValue(P: presentValue, R: interest, PMT: payment)
            
            tf_NoOfMonths.text = String(format:"%.0f", value)
    ...
    @IBAction func SaveBtnPressed(_ sender: UIBarButtonItem) {
        ...
        if(tf_LoanAmount.text != "0" && tf_NoOfMonths.text != "0"){
