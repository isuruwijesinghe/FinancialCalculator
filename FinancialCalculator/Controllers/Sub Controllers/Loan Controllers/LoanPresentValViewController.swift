//
//  LoanPresentValViewController.swift
//  FinancialCalculator
//
...
class LoanPresentValViewController: ParentViewController {
...
//            let presentValue = (tf_LoanAmount.text! as NSString).doubleValue
            ...
            let value : Double = Calculations.calLoanPresentValue(PMT: payment, R: interest, n: noOfPayments)
